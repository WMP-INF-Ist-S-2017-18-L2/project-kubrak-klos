//package com.ur.project.HotelApp.security;
//
//import com.ur.project.HotelApp.HotelAppApplication;
//import com.gmail.konrad.backend.data.Role;
...
//		login = login.loginPage(HotelAppApplication.LOGIN_URL).loginProcessingUrl(HotelAppApplication.LOGIN_PROCESSING_URL)
//				.failureUrl(HotelAppApplication.LOGIN_FAILURE_URL).successHandler(successHandler);
//		login.and().logout().logoutSuccessUrl(HotelAppApplication.LOGOUT_URL);
//	}
//
//}
